...
const Register = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        if (formData.password.length < 6) {
            setError(t('auth.register.passwordTooShort', 'Password must be at least 6 characters'));
            return;
        }
        ...
        if (!phoneRegex.test(formData.phone)) {
            setError(t('auth.register.invalidPhone', 'Please enter a valid Indonesian phone number (e.g., 08123456789)'));
            return;
        }
        ...
        try {
            ...
            setError(err.message || t('auth.register.registerError', 'Registration failed. Please try again.'));
        } finally {
            setLoading(false);
        }
    };
            ...
            >
                ...
                <div style={{ textAlign: 'center', marginBottom: '32px' }}>
                    ...
                    <p style={{ color: '#9ca3af', marginTop: '8px', fontSize: '14px' }}>
                        {t('auth.register.subtitle', 'Join Workspace and boost your productivity')}
                    </p>
                </div>
                ...
                >
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: '16px', marginBottom: '24px' }}>
                        ...
                        <span style={{ color: '#6b7280', fontSize: '12px' }}>or register with email</span>
                        <div style={{ flex: 1, height: '1px', backgroundColor: 'rgba(255,255,255,0.1)' }} />
                    </div>
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <div style={{ marginBottom: '16px' }}>
                            ...
                            <p style={{ fontSize: '11px', color: '#6b7280', marginTop: '4px' }}>
                                {t('auth.register.phoneHint', 'Used for password recovery')}
                            </p>
                        </div>
                        ...
                        >
                            {loading ? t('common.loading', 'Creating account...') : t('auth.register.registerButton', 'Create Account')}
                        </motion.button>
                    </form>
